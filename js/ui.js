(function () {
  ...
  var CSS = [
    ...
    ".ui-toast__close{background:none;border:none;color:#c2c2c2;cursor:pointer;font-size:.85rem;padding:2px 4px;line-height:1;align-self:flex-start;transition:.15s;}",
    ".ui-toast__close:hover{color:#666;}",
    ...
    ".ui-btn{flex:1;padding:12px;border-radius:11px;border:none;font-size:.92rem;font-weight:700;cursor:pointer;font-family:inherit;transition:.18s;display:inline-flex;align-items:center;justify-content:center;gap:7px;}",
