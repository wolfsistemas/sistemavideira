(function () {
  ...
  function injetarEstilos() {
    ...
    style.textContent = [
      ...
      '#videira-pwa-install img{width:40px;height:40px;border-radius:10px;flex-shrink:0;}',
      '#videira-pwa-install p{margin:0;font-size:13px;line-height:1.3;flex:1;}',
      '#videira-pwa-install strong{display:block;font-size:14px;}',
      '#videira-pwa-install button{border:0;border-radius:10px;padding:8px 12px;font-weight:700;cursor:pointer;}',
