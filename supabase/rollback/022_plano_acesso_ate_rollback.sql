-- rollback de 022_plano_acesso_ate.sql
-- Restaura as definicoes anteriores (020 para igreja_liberada e 019 para
-- definir_igreja_plano), ou seja, volta a nao expirar pelo acesso_ate e a
-- nao aceitar acesso_ate na edicao manual.
